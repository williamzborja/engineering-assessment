/*
  ...
  - The primary key for the `MobileFoodFacilityPermit` table will be changed. If it partially fails, the table could be left without primary key constraint.
  - Added the required column `id` to the `MobileFoodFacilityPermit` table without a default value. This is not possible if the table is not empty.
