/*
  ...
  - You are about to alter the column `Approved` on the `MobileFoodFacilityPermit` table. The data in that column could be lost. The data in that column will be cast from `String` to `DateTime`.
